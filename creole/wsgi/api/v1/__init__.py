...
app.add_resource(RestaurantAccountApi, '/restaurant/account/<int:id>', endpoint='get-restaurant-account')
app.add_resource(CreateRestaurantAccountApi, '/restaurant/account/create', endpoint='create-restaurant-account')
